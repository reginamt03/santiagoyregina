    ...
    return (
            <div className={classes.card}>
                ...
                <Grid container direction='row' wrap='wrap' justify='center' alignItems='center'>
                    ...
                    <Grid item xs={6}>
                        <Button target="_blank" variant='outlined' href='https://wa.me/13311332118' className={classes.button}>Enviar Mensaje</Button>
                    </Grid>  
                </Grid>
                <Grid container direction='row' wrap='wrap' justify='center' alignItems='center'>
                    ...
                    <Grid item xs={11}>
                        <Button target="_blank" variant='outlined' href='https://www.lareservaajijic.com/' className={classes.button}>Ir a Sitio Web</Button>
                    </Grid>
                </Grid>
            </div>
            )
